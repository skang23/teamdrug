...
export var InteractionsPage = (function () {
    ...
    InteractionsPage = __decorate([
        Component({
            selector: 'page-interactions',template:/*ion-inline-start:"/Users/liayoo/Desktop/teamdrug/MEDMEN/src/pages/interactions/interactions.html"*/'<!--\n  Generated template for the Interactions page.\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n  	<ion-buttons start>\n	  	<button ion-button icon-only menuToggle>\n	  		<ion-icon name="menu"></ion-icon>\n	  	</button>\n	  </ion-buttons>\n	  <ion-buttons end>\n    	<button ion-button icon-only (click)="logOut()">\n    		<ion-icon name="log-out"></ion-icon>\n    	</button>\n    </ion-buttons>\n    <ion-title>MED MEN</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/liayoo/Desktop/teamdrug/MEDMEN/src/pages/interactions/interactions.html"*/
        }), 
