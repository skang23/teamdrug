...
import * as import0 from './saved-search';
...
export var Wrapper_SavedSearchPage = (function () {
    function Wrapper_SavedSearchPage(p0) {
        this.changed = false;
        this.context = new import0.SavedSearchPage(p0);
    }
    Wrapper_SavedSearchPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_SavedSearchPage;
}());
var renderType_SavedSearchPage_Host = null;
var _View_SavedSearchPage_Host0 = (function (_super) {
    __extends(_View_SavedSearchPage_Host0, _super);
    function _View_SavedSearchPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SavedSearchPage_Host0, renderType_SavedSearchPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SavedSearchPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-saved-search', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_SavedSearchPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._SavedSearchPage_0_4 = new Wrapper_SavedSearchPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._SavedSearchPage_0_4.context, [], compView_0);
        compView_0.create(this._SavedSearchPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SavedSearchPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.SavedSearchPage) && (0 === requestNodeIndex))) {
            return this._SavedSearchPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_SavedSearchPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._SavedSearchPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_SavedSearchPage_Host0;
}(import1.AppView));
function viewFactory_SavedSearchPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SavedSearchPage_Host === null)) {
        (renderType_SavedSearchPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_SavedSearchPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var SavedSearchPageNgFactory = new import10.ComponentFactory('page-saved-search', viewFactory_SavedSearchPage_Host0, import0.SavedSearchPage);
var styles_SavedSearchPage = [];
var renderType_SavedSearchPage = null;
var _View_SavedSearchPage0 = (function (_super) {
    __extends(_View_SavedSearchPage0, _super);
    function _View_SavedSearchPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_SavedSearchPage0, renderType_SavedSearchPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_SavedSearchPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'savedSearch', null);
    ...
    _View_SavedSearchPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_SavedSearchPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_SavedSearchPage0.prototype.destroyInternal = function () {
        this._Content_10_4.context.ngOnDestroy();
    };
    return _View_SavedSearchPage0;
}(import1.AppView));
export function viewFactory_SavedSearchPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SavedSearchPage === null)) {
        (renderType_SavedSearchPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_SavedSearchPage, {}));
    }
    return new _View_SavedSearchPage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=saved-search.ngfactory.js.map