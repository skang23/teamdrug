...
export class Wrapper_NearByStorePage {
  context:import0.NearByStorePage;
  changed:boolean;
...
var renderType_NearByStorePage_Host:import2.RenderComponentType = (null as any);
class _View_NearByStorePage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _NearByStorePage_0_4:Wrapper_NearByStorePage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_NearByStorePage_Host0,renderType_NearByStorePage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-near-by-store',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_NearByStorePage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    this._appEl_0.initComponent(this._NearByStorePage_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._NearByStorePage_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.NearByStorePage) && (0 === requestNodeIndex))) { return this._NearByStorePage_0_4.context; }
...
function viewFactory_NearByStorePage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_NearByStorePage_Host === (null as any))) { (renderType_NearByStorePage_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_NearByStorePage_Host0(viewUtils,parentInjector,declarationEl);
}
export const NearByStorePageNgFactory:import11.ComponentFactory<import0.NearByStorePage> = new import11.ComponentFactory<import0.NearByStorePage>('page-near-by-store',viewFactory_NearByStorePage_Host0,import0.NearByStorePage);
const styles_NearByStorePage:any[] = ([] as any[]);
var renderType_NearByStorePage:import2.RenderComponentType = (null as any);
class _View_NearByStorePage0 extends import1.AppView<import0.NearByStorePage> {
  _text_0:any;
  _el_1:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_NearByStorePage0,renderType_NearByStorePage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
...
export function viewFactory_NearByStorePage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.NearByStorePage> {
  if ((renderType_NearByStorePage === (null as any))) { (renderType_NearByStorePage = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,styles_NearByStorePage,{})); }
