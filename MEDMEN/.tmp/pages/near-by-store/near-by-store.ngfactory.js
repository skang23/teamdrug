...
import * as import0 from './near-by-store';
...
export var Wrapper_NearByStorePage = (function () {
    function Wrapper_NearByStorePage(p0, p1) {
        this.changed = false;
        this.context = new import0.NearByStorePage(p0, p1);
    }
    Wrapper_NearByStorePage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_NearByStorePage;
}());
var renderType_NearByStorePage_Host = null;
var _View_NearByStorePage_Host0 = (function (_super) {
    __extends(_View_NearByStorePage_Host0, _super);
    function _View_NearByStorePage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NearByStorePage_Host0, renderType_NearByStorePage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NearByStorePage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-near-by-store', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_NearByStorePage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._NearByStorePage_0_4 = new Wrapper_NearByStorePage(this.parentInjector.get(import8.NavController), this.parentInjector.get(import9.AuthData));
        this._appEl_0.initComponent(this._NearByStorePage_0_4.context, [], compView_0);
        compView_0.create(this._NearByStorePage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_NearByStorePage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.NearByStorePage) && (0 === requestNodeIndex))) {
            return this._NearByStorePage_0_4.context;
        }
        return notFoundResult;
    };
    _View_NearByStorePage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._NearByStorePage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_NearByStorePage_Host0;
}(import1.AppView));
function viewFactory_NearByStorePage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NearByStorePage_Host === null)) {
        (renderType_NearByStorePage_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_NearByStorePage_Host0(viewUtils, parentInjector, declarationEl);
}
export var NearByStorePageNgFactory = new import11.ComponentFactory('page-near-by-store', viewFactory_NearByStorePage_Host0, import0.NearByStorePage);
var styles_NearByStorePage = [];
var renderType_NearByStorePage = null;
var _View_NearByStorePage0 = (function (_super) {
    __extends(_View_NearByStorePage0, _super);
    function _View_NearByStorePage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NearByStorePage0, renderType_NearByStorePage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NearByStorePage0.prototype.createInternal = function (rootSelector) {
    ...
    _View_NearByStorePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_NearByStorePage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_NearByStorePage0.prototype.destroyInternal = function () {
        this._Icon_9_3.context.ngOnDestroy();
        this._Icon_17_3.context.ngOnDestroy();
        this._Content_26_4.context.ngOnDestroy();
    };
    _View_NearByStorePage0.prototype._handle_click_7_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._MenuToggle_7_5.context.toggle() !== false);
        return (true && pd_0);
    };
    _View_NearByStorePage0.prototype._handle_click_15_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.logOut() !== false);
        return (true && pd_0);
    };
    return _View_NearByStorePage0;
}(import1.AppView));
export function viewFactory_NearByStorePage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NearByStorePage === null)) {
        (renderType_NearByStorePage = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, styles_NearByStorePage, {}));
    }
    return new _View_NearByStorePage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=near-by-store.ngfactory.js.map