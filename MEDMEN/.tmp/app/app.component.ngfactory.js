...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import14.Wrapper_Header(this.parentInjector.get(import20.Config), new import19.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import24.ViewController, null));
        ...
        this._Toolbar_4_4 = new import14.Wrapper_Toolbar(this.parentInjector.get(import24.ViewController, null), this.parentInjector.get(import20.Config), new import19.ElementRef(this._el_4), this.renderer);
        ...
        this._el_9 = this.renderer.createElement(null, 'ion-content', null);
        ...
        this._Content_9_4 = new import15.Wrapper_Content(this.parentInjector.get(import20.Config), new import19.ElementRef(this._el_9), this.renderer, this.parentInjector.get(import25.App), this.parentInjector.get(import21.Keyboard), this.parentInjector.get(import22.NgZone), this.parentInjector.get(import24.ViewController, null), this.parentInjector.get(import26.Tabs, null));
        ...
        var compView_19 = import18.viewFactory_Nav0(this.viewUtils, this.injector(19), this._appEl_19);
        this._Nav_19_4 = new import18.Wrapper_Nav(this.parentInjector.get(import24.ViewController, null), this.parentInjector.get(import29.NavControllerBase, null), this.parentInjector.get(import25.App), this.parentInjector.get(import20.Config), this.parentInjector.get(import21.Keyboard), new import19.ElementRef(this._el_19), this.parentInjector.get(import22.NgZone), this.renderer, this.parentInjector.get(import30.ComponentFactoryResolver), this.parentInjector.get(import23.GestureController), this.parentInjector.get(import31.TransitionController), this.parentInjector.get(import32.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import33.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
            return this._Toolbar_4_4.context;
        }
        if (((token === import33.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 7)))) {
        ...
        if (((token === import36.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Content_9_4.context;
        }
        if (((token === import37.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._Menu_0_4.context;
        }
        if (((token === import38.Nav) && (19 === requestNodeIndex))) {
